...
def detect_objects(input_bev_maps, model, configs):
    ...
    if len(detections) > 0:
        ...
        for detection in detections:
            ...
            object_id, object_y, object_x, object_z, object_h, object_w, object_l, object_yaw = detection
            
            x_diff = configs.lim_x[1] - configs.lim_x[0]
            y_diff = configs.lim_y[1] - configs.lim_y[0]
            
            x = (object_x / configs.bev_height) * x_diff
            y = (object_y / configs.bev_width) * y_diff - y_diff/2.0
            
            w = (object_w / configs.bev_width) * y_diff
            l = (object_l / configs.bev_height) * x_diff
            
            objects.append([object_id, x, y, object_z, object_h, w, l, -object_yaw])
